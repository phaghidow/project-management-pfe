...
<div class="p-6 max-w-2xl mx-auto">
    ...
    <form method="POST" action="{{ route('admin.structures.update', $structure) }}" class="bg-white shadow-xl rounded-2xl p-8">
        ...
        <div class="flex flex-col-reverse gap-4 mt-8 pt-6 border-t border-gray-200 sm:flex-row sm:justify-end">
            ...
            <button type="submit" class="inline-flex items-center justify-center px-8 py-3 rounded-lg bg-success-500 text-white shadow hover:bg-green-700 focus:bg-green-700 active:bg-green-800 transition !text-white">
                Mettre à jour
            </button>
        </div>
    </form>
