...
<div class="page-mobile">
    ...
    <form method="POST" action="{{ route('projects.store') }}" class="responsive-form">
        @csrf
        ...
        <div class="bg-white p-6 shadow rounded-lg">
            <div class="responsive-form-grid md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm resize-vertical">{{ old('description') }}</textarea>
