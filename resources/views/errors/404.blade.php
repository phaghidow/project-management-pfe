...
<head>
    ...
    <title>404 - Gestion Projets</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand-panel {
            padding: 28px;
            background:
                linear-gradient(180deg, rgba(37, 99, 235, 0.08), rgba(15, 23, 42, 0.04)),
    ...
    <main class="card" role="main" aria-labelledby="page-title">
        <div class="grid">
            <section class="content">
                ...
                <h1 id="page-title">La page demandée n'existe pas.</h1>
                <p>
                    Le lien est peut-être ancien, mal saisi, ou la ressource a été déplacée. Revenez à l’accueil pour continuer à gérer vos projets.
                </p>
                ...
                <div class="hint">Gestion Projets • support DSI / MOI</div>
            </section>
