...
<div class="page-mobile max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold mb-6">Nouveau jalon</h1>

    <form method="POST" action="{{ route('milestones.store') }}" class="responsive-form">
        @csrf
        ...
        <div class="responsive-form-actions">
            ...
            <x-primary-button type="submit">Créer le jalon</x-primary-button>
        </div>
    </form>
</div>
</x-app-layout>
